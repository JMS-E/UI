...
public class ControllerManagerSample : MonoBehaviour
{
 ...
 //edited
            case CurvePointerActiveModeEnum.DPadDown:
                needUpdate |= SetRightCurvePointerActive(ViveInput.GetPressEx(HandRole.RightHand, ControllerButton.DPadDown));
                needUpdate |= SetLeftCurvePointerActive(ViveInput.GetPressEx(HandRole.LeftHand, ControllerButton.DPadDown));
                break;

            case CurvePointerActiveModeEnum.TriggerButon:
                needUpdate |= SetRightCurvePointerActive(ViveInput.GetPressEx(HandRole.RightHand, ControllerButton.Trigger));
                needUpdate |= SetLeftCurvePointerActive(ViveInput.GetPressEx(HandRole.LeftHand, ControllerButton.Trigger));
                break;
//end edit block
