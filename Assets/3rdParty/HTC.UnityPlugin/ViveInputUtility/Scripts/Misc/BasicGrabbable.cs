...
namespace HTC.UnityPlugin.Vive
{
        ...
        , IColliderEventDragEndHandler
    {
        ...
        #region etvr
        public bool grabAndTranslate = true; //copy only rotation values
        #endregion
 ...
 //ETVR addition
        ...
        {
            if (grabAndTranslate && isGrabbed && moveByVelocity && currentGrabber.eventData == eventData)
            {
                OnGrabRigidbody();
            }
